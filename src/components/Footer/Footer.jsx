    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul>
           <Link to="/coin/bitcoin"> <li><a >Bitcoin (BTC)</a></li></Link>
           <Link to="/coin/etherum"> <li><a href="#ethereum">Ethereum (ETH)</a></li></Link>
            <Link to="/coin/cardano"><li><a href="#cardano">Cardano (ADA)</a></li></Link>
          <Link to="/coin/polkadot"><li><a href="#polkadot">Polkadot (DOT)</a></li></Link>
          </ul>
        </div>
        <div className="footer-section">
